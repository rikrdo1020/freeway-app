...
<form action="/clientes"  autocomplete="off" method="POST">
@csrf
<div class="row">
    <div class="col-lg-8 me-3 mb-3">
        ...
        <div class="mb-3">
            <div class="col-4">
                ...
                <input id="nombreCompleto" name= "nombreCompleto" type="text" class="form-control" tabindex="1" required>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="telefono" name= "telefono" type="text" class="form-control" tabindex="4" required>
        </div>
        <div class="row g-3 align-items-center mb-3">
            <div class="col-auto monto">
                <label for="" class="form-label">Monto</label>
                <input id="monto" name="monto" type="number" class="form-control" placeholder="00.00" onChange="suma();" required>
            </div>
            <div class="col-auto monto">
                <label for="" class="form-label">Abono</label>
                <input id="abono" name="abono" type="number" class="form-control" placeholder="00.00" onChange="suma();">
            </div>
            
                <div class="col-auto">
                    <label for="" class="form-label">Pendiente</label>
                    <input id="pendiente" name="pendiente" type="number" class="form-control" placeholder="00.00" onChange="suma();" readonly>
            </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-8">
                <input id="cancelacion" name="cancelacion" class="form-control" type="date" value="" >
            </div>
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Tipo de Curso de Manejo</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_curso" value="Particular" id="tipo_curso">
                <label class="form-check-label" for="flexRadioDefault1"  >
                    Particular
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_curso" value="Comercial" id="tipo_curso">
                <label class="form-check-label" for="flexRadioDefault2"  >
                    Comercial
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_curso" value="Moto" id="tipo_curso" >
                <label class="form-check-label" for="flexRadioDefault2"  >
                    Moto
                </label>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="radio" name="tipo_transmision" value="Automática" id="tipo_transimision" >
                <label class="form-check-label" for="flexRadioDefault1" name="tipo_transmision"  >
                    Automática
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="tipo_transmision" value="Manual" id="tipo_transimision" >
